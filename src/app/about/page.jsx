...
export default function Home() {
  ...
  const speakText = () => {
    const speech = new SpeechSynthesisUtterance("Hello people,I am goutham from vnr vignana jyothi institute of technology and engineering");
  ...
  return (
    <div className="container mx-auto mt-10 p-4 bg-orange-100 rounded shadow-lg">
      <textarea className="w-full h-40 mb-4 p-2 border border-gray-300 rounded resize-y outline-none"
        placeholder="Enter text to convert" value="Hello people,I am goutham from vnr vignana jyothi institute of technology and engineering"
        // value={textToSpeak} onChange={(e) => setTextToSpeak(e.target.value)}
      />
